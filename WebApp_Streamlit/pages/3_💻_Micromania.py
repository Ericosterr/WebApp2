...
class MicromaniaScraper:
    ...
    def scrape_product_descriptions(self):
        ...
        description_elements = soup.find_all(['div'], {'class': ['pdp-name-block mm-p-t-20', 'pdp-info-msg pdp-merchant-msg d-block d-lg-inline color-black-original eina-semibold-font-family bold-text', 'pt-0 pdp-platform-msg pdp-merchant-msg color-black-original eina-semibold-font-family bold-text js-compatibility', 'pdp-platform-msg pdp-merchant-msg d-block color-black-original eina-semibold-font-family', 'a-size-large product-title-word-break', 'a-list-item']})
    ...
    def scrape_product_image_url(self):
        ...
        image_elements = soup.find_all(['img'], {'class': ['main-carousel-image-large d-block d-lg-none img-fluid mw-100 mh-100 carousel-image-large','a-dynamic-image a-stretch-horizontal']})
        if image_elements:
...
st.title("Micromania Web Scraper")
