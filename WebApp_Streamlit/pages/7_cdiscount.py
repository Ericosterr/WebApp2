...
class MicromaniaScraper:
    ...
    def scrape_product_descriptions(self):
        ...
        description_elements = soup.find_all(['div'], {'class': ['c-fp-heading__title u-mb-xs', 'c-productHighlights', 'pt-0 pdp-platform-msg pdp-merchant-msg color-black-original eina-semibold-font-family bold-text js-compatibility', 'pdp-platform-msg pdp-merchant-msg d-block color-black-original eina-semibold-font-family', 'a-size-large product-title-word-break', 'a-list-item']})
    ...
    def scrape_product_image_url(self):
        ...
        image_elements = soup.find_all(['img'], {'class': ['img-fluid']})
        if image_elements:
